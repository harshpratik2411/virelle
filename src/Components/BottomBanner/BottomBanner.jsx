...
const BottomBanner = () => {
  ...
  return (
    <>
      {/* === Hero Banner Section === */}
      <section
        className="bg-gray-medium lg:w-[92rem] rounded-lg  text-black py-12 px-4 md:px-16 font-rubik"
        ref={sectionRef}
      >
        <motion.div
      ...
      <section
        className="bg-gray-medium lg:w-[92rem]  text-black py-12 px-4 md:px-16 font-rubik"
        ref={statsRef}
      >
        <motion.div
          className="w-full mx-auto text-center"
